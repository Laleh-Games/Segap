...
public class FPS : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip level_snd;
    [SerializeField] private AudioClip Meaze_snd;
    private bool flog=true;
    private bool flog_auido_1 = true;
    private bool flog_auido_2 = true;
    ...
    {
        if (other.gameObject.tag== "level_snd")
        {
            if (flog_auido_1)
            {
                _audioSource.clip = level_snd;
                flog_auido_1 = false;
                flog_auido_2 = true;
            }
        }
        else if (other.gameObject.tag == "Meaze_snd")
        {
            if (flog_auido_2)
            {
                _audioSource.clip = Meaze_snd;
                flog_auido_2 = false;
                flog_auido_1 = true;
            }
